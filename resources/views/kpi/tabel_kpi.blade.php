		...
		<div class="fl-container">
			<div class="fl-title-page" >
				...
				<span style="float:right;margin-top:15px">
					...
					<button class="uk-button uk-button-primary fl-button" type="button">+</button>
				</span>
			</div>
					...
					<table class="uk-table uk-table-hover uk-table-middle uk-table-divider">
						<thead>
							<tr class="fl-table-head">
								...
								<th width="30%">Unit Pengukuran</th>
						...
						<tbody>
							...
							?>
								<tr>
									...
									<td>Rata Rata untuk setiap jobdesk</td>
									<td><b>90/100</span></b></td>
									<td><b>70/100</span></b></td>
									<td>
