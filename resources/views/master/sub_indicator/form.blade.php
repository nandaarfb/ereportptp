			...
			<div class="fl-table">
				<form id="form_perencanaan" action="/master/sub_indicator_save" method="POST">
					...
					<div>
						...
						<input name="sub_indicator_name" class="uk-input uk-child-width-1-2" type="text" placeholder="Sub Indicator Name">
					</div>
					<div>
						<b>Unit</b>
						<input name="sub_unit" class="uk-input uk-child-width-1-2" type="text" placeholder="Unit">
					</div>
					<div>
						<br>
					</div>
